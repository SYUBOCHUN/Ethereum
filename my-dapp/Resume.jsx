...
import product3 from "/Users/mac/Desktop/my-dapp/src/assets/img/product3.jpg";
import block from "/Users/mac/Desktop/my-dapp/src/assets/img/block.png";
import QRcode from "/Users/mac/Desktop/my-dapp/src/assets/img/QRcode.png";
...
class Resume extends React.Component {
  ...
  componentWillMount() {
    ...
    var person=prompt("請輸入你的合約地址","0x39c879d12f24f1dbd9f4b4c6fc39aa56263b35d9d335d12a8c899c8795031966");
    
    //參考網址:https://juejin.im/entry/587de1b32f301e0057a28897
    //在Reactjs的componentWillMount函數中，或在render()之前先執行內容。
    var url = window.location.href+"/"+person;
    var transactionAddress = url.split("/");
    this.setState({receiptaddress: transactionAddress[4]}, function() {this.getTransactions(web3.eth.getTransactionReceipt(this.state.receiptaddress).contractAddress)});
    this.setState({receiptaddress: transactionAddress[4]}, function() {this.statedecide()});
  ...
  render() {
    ...
    return (
      ...
      <RegularCard
        cardTitle={`產品智能合約帳戶：${web3.eth.contract(this.state.abi).at(web3.eth.getTransactionReceipt(this.state.receiptaddress).contractAddress).address}`}
        cardSubtitle={
          <P>
            Transaction Address:
            <br></br>
        ...
        content={
          ...
          <div>
            <Grid container justify="center">
              ...
              {/* 圖片
              <img src={product3} width="850" height="300"/>
              */}
            <br />
              <ItemGrid xs={16} sm={16} md={10}>
                <br />
                {/*
                <img src={QRcode} width="148" height="148" align="left"/>
                */}
          <div>
          {
          //這是第二個查詢智能合約地址的Modal
          ...
          {this.state.accountTransactions.length > 0
                  ...
                  <Collapse component="li" in={this.state[`open${idx}`]} timeout="auto" unmountOnExit>                 
                    <List disablePadding>  
                      ...
                      <ListItem>  
                        ...
                        <ListItemText inset primary={`作業員(Operator): ${d.from}`} />
                      </ListItem>
                      <ListItem>  
                        <ListItemIcon>
                          <AccessTime />
            ...
            : `目前產品履歷的智能合約已被建立至區塊鏈中，狀態為：工站A確中。` }
          {
